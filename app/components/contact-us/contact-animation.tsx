...
export default function ContactInfoAnimation() {
  ...
  return (
    <div
      className="flex flex-col md:flex-row items-center justify-between gap-15 w-fit font-satoshi font-medium"
      ref={canvasRef}
    >
      <motion.div
        key={1}
      ...
      >
        <div className="illustration email bg-white/5 backdrop-blur-md">
          ...
          >
            ...
            <div className=" w-full h-full items-start flex flex-col gap-3">
      ...
      >
        <div className="illustration">
          ...
          >
            ...
            <div className=" h-full flex flex-col items-start flex-1 gap-4">
              <Link to="mailto:omemcompany@gmail.com">
                omemcompany@gmail.com
              </Link>
              <Link to="mailto:aimmaxcom@gmail.com">aimmaxcom@gmail.com</Link>
            </div>
          </div>
        </div>
      </motion.div>
