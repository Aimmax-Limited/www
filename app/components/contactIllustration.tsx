  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-15 w-fit">
      ...
      >
        ...
        <div className={`mt-4  pt-2 hidden ${isVisible ? "rollout flex  gap-8" : "flex gap-10"}`}>
      ...
      >
        <div className="illustration phone  bg-white/5 backdrop-blur-md">
          <div className={`mt-4 pt-3 hidden ${isVisible ? "rollout flex  gap-8" : "flex gap-8"}`}>
            <div className="flex justify-start h-full animate-pulse mt-2 pl-4"><svg
              width="50"
              height="40"
              viewBox="0 0 24 24"
              fill="none"
